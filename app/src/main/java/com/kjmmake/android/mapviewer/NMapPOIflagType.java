...
public class NMapPOIflagType {
	...
	public static final int PIN_0 = SPOT + 2;
	public static final int PIN_1 = SPOT + 3;
	public static final int PIN_2 = SPOT + 4;
	public static final int PIN_3 = SPOT + 5;
	public static final int PIN_4 = SPOT + 6;
	public static final int PIN_5 = SPOT + 7;
	public static final int PIN_6 = SPOT + 8;
	public static final int PIN_7 = SPOT + 9;
	public static final int PIN_8 = SPOT + 10;
